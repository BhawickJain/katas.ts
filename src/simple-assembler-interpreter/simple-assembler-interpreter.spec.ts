import { jnz, dec, ExecutionContext, inc, mov, simple_assembler, getLine } from "./simple-assembler-interpreter"
...
test("mov can identify, getArgs and evaluate the assignment of a value a named register", () => {
	...
	expect(mov.evaluate(args, executionContext)).toStrictEqual(expectedNewExecutionContext)
})
...
test("inc can identify, getArgs and evaluate the assignment of a value a named register", () => {
	...
	expect(inc.evaluate(args, executionContext)).toStrictEqual(expectedNewExecutionContext)
})
...
test("dec can identify, getArgs and evaluate the assignment of a value a named register", () => {
	...
	expect(dec.evaluate(args, executionContext)).toStrictEqual(expectedNewExecutionContext)
})
...
test("jnz can identify, getArgs and evaluate the assignment of a value a named register", () => {
	...
	expect(jnz.evaluate(args, executionContext)).toStrictEqual(expectedNewExecutionContext)
})
